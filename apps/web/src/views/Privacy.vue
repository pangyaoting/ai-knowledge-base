    ...
    <div class="space-y-6 text-sm leading-relaxed text-foreground/90">
      ...
      <section>
        ...
        <ul class="list-disc space-y-1 pl-5">
          ...
          <li>
            保存期限：数据保存至你主动删除（知识库/文档/会话/报告可逐项删除）或**自助注销账号**为止；
            注销为永久删除，不可恢复。
          </li>
      ...
      <section>
        ...
        <ul class="list-disc space-y-1 pl-5">
          ...
          <li>
            <strong>注销账号</strong>：可在「个人中心 →
            注销账号」**自助注销**（需输入当前密码确认），
            账号及全部关联数据（知识库、文档、对话、报告、研究任务、模型配置）将<strong>立即永久删除且不可恢复</strong>；也可发邮件到下方邮箱申请，我们核实身份后代为删除。
          </li>
          <li>
